...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case '':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('_assets');
				frames = tex;
			...
			case '-christmas':
				tex = Paths.getSparrowAtlas('christmas/Christmas');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case '-pixel':
				tex = Paths.getSparrowAtlas('weeb/Pixel');
				frames = tex;
			...
			case 'parents-christmas':
				...
				case 'Black':
				frames = Paths.getSparrowAtlas('fase black/black_assets');
				animation.addByPrefix('idle', 'black idle', 24, false);
